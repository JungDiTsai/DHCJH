            ...
            <main  id="host" class="col-md-10 ml-auto panel">
                    ...
                    <table class="table table-hover">
                            <thead>
                                ...
                                <th scope="col">介紹</th>
                                <th scope="col">能力值Ａ</th>
                                <th scope="col">能力值Ｂ</th>
                                <th scope="col">能力值Ｃ</th>
                                <th scope="col">能力值Ｄ</th>
                                <th scope="col">能力值Ｅ</th>
                                <th scope="col">能力值Ｆ</th>
                                <th scope="col">價格</th>
                                <th scope="col">狀態</th>
                            ...
                            <tbody>
                                ...
                                <tr class="back">
                                    ...
                                    <td class="change">
                                    <button type="button" class="<?php if($hostTotal["hostStatus"]=="啟用"){
                                        echo 'btn btn-success';}else{ echo 'btn btn-danger';}?> ">
                                        <?php echo $hostTotal["hostStatus"]; ?></td>
                                
                                    <td class=""><button type="button" class="btn btn-link btnclick" value=<?php echo $hostTotal["hostNo"]; ?> >修改</button></td>
                                    <td class=""><button type="button" class="btn btn-link delclick" value=<?php echo $hostTotal["hostNo"]; ?> >刪除</button></td>
